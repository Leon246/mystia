...
/*Normal way to stat. nucleic acid sequences
 * read as loop
 *will omit less than K_dim nucleic acids
 *still a bug
 */

import java.io.*;

public class DNA_normal_stat {
	
	public static int K_dim = 6;
	...
	public DNA_normal_stat() throws IOException {
		String strfilename =
...
//		"E:\\My Documents\\GThesis\\Data\\Thermoanaerobacter_tengcongensis\\NC_003869.fna";
	...
	public void System_out() throws IOException {
		if (K_dim == 3) {
			...
			String outfilename = "D:\\My Documents\\GThesis\\Res\\DNA_normal_out.txt";
			String strbuffer = new String();
			try {
				FileOutputStream outfile = new FileOutputStream(outfilename);
				DataOutputStream outdata = new DataOutputStream(outfile);
				
				strbuffer = new String("DNA_normal_out, start point of : " + start_point);
